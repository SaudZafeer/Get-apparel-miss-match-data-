...
def ordering():
    ...
    for rejected_chart in range(1,50):
        ...
        while True:
            ...
            if i >= 26:
                ...
                try:
                    ...
                    print(image)
                    style_locator = "/html/body/div[7]/div/div[1]/div[5]/table/tbody/tr[{}]/td[1]/div/div[1]/div[2]/div[4]".format(i)
                    style = WebDriverWait(driver,10).until(ec.presence_of_element_located((By.XPATH,style_locator))).text
                    print(style)
                    ...
                    print(confirmed)
                    Rejected_locator='/html/body/div[7]/div/div[1]/div[5]/table/tbody/tr[{}]/td[1]/div/div[3]/div[2]/span[5]/span[2]/span'.format(i)
                    ...
                    print(order_number)
                    product_data = pd.DataFrame({"image":[image],"PO Number":[po_number],"Order Number":[order_number],"styles":[style],"Name":[name],"requested":[request],"Confirmed":[confirmed],"Rejected":[Rejected]})
        ...
        print(image)
        name = WebDriverWait(driver,10).until(ec.presence_of_element_located((By.XPATH,"/html/body/div[7]/div/div[1]/div[5]/table/tbody/tr[1]/td[1]/div/div[1]/div[2]"))).text
        print(name)
        style = WebDriverWait(driver,10).until(ec.presence_of_element_located((By.XPATH,"/html/body/div[7]/div/div[1]/div[5]/table/tbody/tr[1]/td[1]/div[1]/div[1]/div[2]/div[4]"))).text
        print(style)
        ...
        try:
            ...
            print("Result button not found")
            try:
                result_button1 = driver.find_element(By.XPATH,'/html/body/div[5]/nav/div/div[2]/a')
                result_button1.click()
            except:
                print("Result button not found 2")
